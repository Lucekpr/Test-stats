...
import { showCensusDashboard } from './modules/census_dashboard.js';
...
export default {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                        .setName("census")
                .setDescription("Open the interactive Census configuration panel")
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName("delete")
    ...
    async execute(interaction, guildConfig, client) {
        ...
        switch (subcommand) {
            ...
            case "delete":
                ...
                break;
            case "census":
                await showCensusDashboard(interaction, client);
                break;
            default:
